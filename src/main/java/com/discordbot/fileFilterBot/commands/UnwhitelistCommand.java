...
public class UnwhitelistCommand {
    private final ConfigManager configManager;

    public UnwhitelistCommand(ConfigManager configManager) {
        this.configManager = configManager;
    }

    public static ApplicationCommandRequest getCommandRequest() {
        return ApplicationCommandRequest.builder()
                .name("unwhitelistfiletype")
                .description("Unwhitelist a file type")
                .addOption(ApplicationCommandOptionData.builder()
                        .name("file-type")
                        .description("The file type to unwhitelist")
    ...
    public Mono<Void> handle(ChatInputInteractionEvent event) {
        ...
        configManager.removeFromWhiteList(fileType);


        return event.reply()
                .withEphemeral(true)
                .withContent(fileType + " removed from whitelist");
    }
}
