...
public class UnblacklistCommand {
    ...
    public UnblacklistCommand(ConfigManager configManager) {
        this.configManager = configManager;
    }

    public static ApplicationCommandRequest getCommandRequest() {
        return ApplicationCommandRequest.builder()
                .name("unblacklistfiletype")
                .description("UnBlacklist a file type")
                .addOption(ApplicationCommandOptionData.builder()
                        .name("file-type")
                        .description("The file type to remove from blacklist")
    ...
    public Mono<Void> handle(ChatInputInteractionEvent event) {
        ...
        configManager.removeFromBlackList(fileType);


        return event.reply()
                .withEphemeral(true)
                .withContent(fileType + " removed from blacklist");
    }
}